...
thing = [(0,0),(1,1.5),(0,2),(1,3),(1,3.5),(0,0+4),(1,1.5+4),(0,2+4),(1,3+4),(1,3.5+4),(0,8),(1,9),(0,9.5),(1,10),(1,10.5),(0,11),(1,12),(1,13),(0,13.5),(0,14),(1,15),(0,16)]
for i in range(len(thing)):
    thing[i] = (thing[i][0], thing[i][1]+6)
length = len(thing)
for i in range(len(thing)):
    thing.append((thing[i][0], thing[i][1]+6+16))
rhythm2 = Rhythm(120, 30, thing, 'music/FunkPump.wav', 20)
rhythm3 = Rhythm(65, 20, [(0,0),(2,0.5),(0,1),(2,1.5),(0,0+2),(2,0.5+2),(0,1+2),(2,1.5+2),(0,0+4),(2,0.25+4),(1,0.5+4),(2,0.75+4),(0,1+4),(2,1.25+4),(1,1.5+4),(2,1.75+4),(0,0+6),(1,0.25+6),(2,0.5+6),(1,0.75+6),(0,1+6),(1,1.25+6),(2,1.5+6),(1,1.75+6),(0,0+8),(0,0+4+4),(2,0.25+4+4),(1,0.5+4+4),(2,0.75+4+4),(0,1+4+4),(2,1.25+4+4),(1,1.5+4+4),(2,1.75+4+4),(0,0+6+4),(1,0.25+6+4),(2,0.5+6+4),(1,0.75+6+4),(0,1+6+4),(1,1.25+6+4),(2,1.5+6+4),(1,1.75+6+4),(0,12),(0,12.25),(1,12.5),(1,12.75),(2,13),(0,13.25),(2,13.5),(1,14),(2,14.25),(1,14.5),(0,15),(3,16),(0,16.25),(1,16.5),(1,16.75),(1,17.25),(0,17.75),(0,18),(3,18.5),(2,18.75),(0,19),(1,19.5),(2,19.75),(3,20)], 'music/SpaceshipHangar.wav', 60)